...
대상 spec의 `Open Questions` 항목을 모두 추출해 사용자에게 보여주고, 다음을 묻는다:

- **이번 호출에서 어떤 항목을 닫을 것인가** (전부 / 일부 선택).
- 항목이 5개를 넘으면 어떤 묶음으로 라운드를 나눌지 (관련 항목끼리 묶기 권장).

명시 승인 전에는 다음 단계로 넘어가지 않는다.
