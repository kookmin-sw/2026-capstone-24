...
| 이름 | 상태 | 링크 |
|---|---|---|
| Three-Hand Architecture Validation | Done | [specs/01-three-hand-architecture-validation.md](../_archive/hands/specs/01-three-hand-architecture-validation.md) |
| Instrument No-Penetration | Draft | [specs/02-instrument-no-penetration.md](specs/02-instrument-no-penetration.md) |
| Left Pinch Gesture | Draft | [specs/03-left-pinch-gesture.md](specs/03-left-pinch-gesture.md) |
