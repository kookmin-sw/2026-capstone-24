...
| 작성일 | 제목 | 상태 | 링크 |
|---|---|---|---|
| 2026-05-07 | AWS dev 토폴로지 (EC2 Spring + MariaDB, ECS Fargate room-server) | `Done` (2026-05-25 — 5/8 AC 통과, 운영 자계 3건은 deferred) | [2026-05-07-namae1128-aws-dev-topology-ec2-fargate.md](../../_archive/multiplayer-network/plans/2026-05-07-namae1128-aws-dev-topology-ec2-fargate.md) |
