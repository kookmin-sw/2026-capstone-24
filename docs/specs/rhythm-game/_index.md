...
| 이름 | 상태 | 링크 |
|---|---|---|
| Chart Format | Draft | [`specs/chart-format.md`](specs/chart-format.md) |
...
| Timing Clock | Draft | [`specs/timing-clock.md`](specs/timing-clock.md) |
| Judgment | Draft | [`specs/judgment.md`](specs/judgment.md) |
...
- [ ] 노트 시각화 UI(떨어지는 노트 등)를 별도 sub-spec으로 추가할 시점.
