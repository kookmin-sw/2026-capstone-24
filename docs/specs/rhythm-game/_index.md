...
| Session Lead-in | Draft | [`specs/01-session-lead-in.md`](specs/01-session-lead-in.md) |
| Note Visual Fidelity | Draft | [`specs/02-note-visual-fidelity.md`](specs/02-note-visual-fidelity.md) |
